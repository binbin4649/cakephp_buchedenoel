...
define('NEW_SHOP_FLAG', '2015-04-30');
...
function get_overseashop_list(){
	return array(
		...
		//'10'=>'490',//香港SOGO
		'11'=>'491',//THE KISS Sands Cotai 
		//'12'=>'502',//香港Hyson 
		'13'=>'507',//Venetian POP Store 
	);
}
...
function get_itemtype(){//アイテムの型、タイプ
	return array(
		'1'=>__('リング',true),//リング
		'2'=>__('ネックレス',true),//ネックレス
		'3'=>__('ネックレスチェーン',true),//ネックレスチェーン
		'4'=>__('ペンダントトップ',true),//ペンダントトップ
		'5'=>__('ブレスレット・バングル',true),//ブレスレット・バングル
		'6'=>__('ピアス',true),//ピアス
		'7'=>__('アンクレット',true),//アンクレット
		'8'=>__('ウオッチ',true),//ウオッチ
		'9'=>__('ストラップ',true),//ストラップ
		'10'=>__('ライター',true),//ライター
		'11'=>__('マリッジ',true),//マリッジ
		'12'=>__('エンゲージ',true),//エンゲージ
		'13'=>__('ネックレスチャーム',true),
		'14'=>__('ロングネック',true),
		'15'=>__('プチペンダント',true),
		'16'=>__('',true),
		'17'=>__('イヤリング',true),
		...
		'52'=>__('バッグチャーム',true),
		'53'=>__('ウォッチチャーム',true),
		'54'=>__('キーホルダーストラップ',true),
		'55'=>__('キーホルダー',true),
		'56'=>__('ピアスチャーム',true),
		'57'=>__('スマートフォンケース',true),
		'58'=>__('ルース',true),
		'59'=>__('アパレル',true),
		'60'=>__('ミニポニー',true),
		'61'=>__('ファッション雑貨',true),
