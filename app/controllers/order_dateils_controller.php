		...
		*/
		...
		if (!empty($this->data)) {
			...
			if($this->data[$modelName]['csv'] == 1){
				...
				//scpテスト
				$shell_exec1 = 'scp /root/.ssh/id_rsa /var/www/html/buchedenoel/app/webroot/files/user_csv/'.$file_name.' idempiere-dev@idempiere.thekiss-landh.com:/home/idempiere/from_oreore/';
