<div class="amountCompanies index">
<h2><?php __('AmountCompanies');?></h2>
<?php
$modelName = 'AmountCompany';
echo $form->create($modelName ,array('action'=>'index'));
echo $form->input($modelName.'.company_id', array(
	'type'=>'text',
	'label'=>'Company',
	'div'=>false,
	'size'=>7
...
<?php
$i = 0;
foreach ($amountCompanies as $amountCompany):
	$class = null;
	if ($i++ % 2 == 0) {
		$class = ' class="altrow"';
	}
?>
	<tr<?php echo $class;?>>
		...
		<td>
			<?php echo $html->link($amountCompany['AmountCompany']['name'], array('action'=>'edit', $amountCompany['AmountCompany']['id'])); ?>
		</td>
		<td>
