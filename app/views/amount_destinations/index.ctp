<div class="amountDestinations index">
<h2><?php __('AmountDestinations');?></h2>
<?php
...
<?php
$i = 0;
foreach ($amountDestinations as $amountDestination):
	$class = null;
	if ($i++ % 2 == 0) {
		$class = ' class="altrow"';
	}
?>
	<tr<?php echo $class;?>>
		...
		<td>
			<?php echo $html->link($amountDestination['AmountDestination']['name'], array('action'=>'edit', $amountDestination['AmountDestination']['id'])); ?>
		</td>
		<td>
