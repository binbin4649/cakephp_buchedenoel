<div class="amountItemtypes form">
<?php echo $form->create('AmountItemtype');?>
	<fieldset>
 		<legend><?php __('Add AmountItemtype');?></legend>
	<?php
		...
		echo $form->input('itemtype', array(
			'type'=>'select',
			'options'=>$itemtype,
			'div'=>true,
			'label'=>__('Itemtype', true),
		));
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('List AmountItemtypes', true), array('action'=>'index'));?></li>
	</ul>
</div>
