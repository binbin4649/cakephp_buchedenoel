<div class="amountMajorSizes form">
<?php echo $form->create('AmountMajorSize');?>
	<fieldset>
 		<legend><?php __('Edit AmountMajorSize');?></legend>
	<?php
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('List AmountMajorSizes', true), array('action'=>'index'));?></li>
	</ul>
</div>
