<div class="amountMaterials form">
<?php echo $form->create('AmountMaterial');?>
	<fieldset>
 		<legend><?php __('Edit AmountMaterial');?></legend>
	<?php
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('List AmountMaterials', true), array('action'=>'index'));?></li>
	</ul>
</div>
