<div class="amountPairs form">
<?php echo $form->create('AmountPair');?>
	<fieldset>
 		<legend><?php __('Edit AmountPair');?></legend>
	<?php
		...
		echo $form->input('item_ladys');
		echo $form->input('item_mens');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('List AmountPairs', true), array('action'=>'index'));?></li>
	</ul>
</div>
