<div class="amountSalesCodes form">
<?php echo $form->create('AmountSalesCode');?>
	<fieldset>
 		<legend><?php __('Edit AmountSalesCode');?></legend>
	<?php
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('AmountSalesCode.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('AmountSalesCode.id'))); ?></li>
