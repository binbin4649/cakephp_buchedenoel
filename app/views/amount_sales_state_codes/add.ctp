<div class="amountSalesStateCodes form">
<?php echo $form->create('AmountSalesStateCode');?>
	<fieldset>
 		<legend><?php __('Add AmountSalesStateCode');?></legend>
	<?php
		...
		echo $form->input('sales_state_code_id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('List AmountSalesStateCodes', true), array('action'=>'index'));?></li>
	</ul>
</div>
