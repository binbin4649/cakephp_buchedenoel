<div class="amountSections form">
<?php echo $form->create('AmountSection');?>
	<fieldset>
 		<legend><?php __('Edit AmountSection');?></legend>
	<?php
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('AmountSection.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('AmountSection.id'))); ?></li>
		<li><?php echo $html->link(__('List AmountSections', true), array('action'=>'index'));?></li>
	</ul>
</div>
