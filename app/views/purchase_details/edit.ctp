...
<?php echo $form->create('PurchaseDetail');?>
	<fieldset>
 		<legend><?php __('Edit PurchaseDetail');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('PurchaseDetail.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('PurchaseDetail.id'))); ?></li>
